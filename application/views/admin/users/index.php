...
<?php if (count($users) > 0): ?>
        ...
        <tbody>
            <?php foreach($users as $user): ?>
                <tr>
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo Url::base(TRUE).$current_role ?>/profiles/show/<?php echo $user->id ?>"><i class="icon-info-sign"></i> Show profile</a></li>
                        <li><a href="<?php echo Url::base(TRUE).$current_role ?>/profiles/edit/<?php echo $user->id ?>"><i class="icon-pencil"></i> Edit profile</a></li>
                        <li class="divider"></li>
                  ...
                  <td><a href="<?php echo Url::base(TRUE).$current_role ?>/users/role/<?php echo $user->get_role()->id ?>"><?php echo $user->get_role()->name ?></a></td>
    ...
    <?php echo $page_links ?>
<?php else: ?>
    <p class="nothing">There are no users yet.</p>
<?php endif ?>