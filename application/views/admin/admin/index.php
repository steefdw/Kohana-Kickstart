<h2><?php echo __('Dashboard'); ?></h2>
  ...
  <?php echo HTML::anchor($current_role.'/users/',     __('Show users'), array('class' => 'btn btn-primary')); ?>
  <?php echo HTML::anchor($current_role.'/profiles/',     __('Show profiles'), array('class' => 'btn btn-primary')); ?>
  <?php echo HTML::anchor('account/create/',     __('Create account'), array('class' => 'btn btn-success')); ?>
  <?php echo HTML::anchor('#',     __('Red button'), array('class' => 'btn btn-danger')); ?>
  <br /><br />
<div class="row">
<div class="span6">
